...
class SusGripClient:
    """
    Beginner-friendly SusGrip (Modbus RTU over RS485) driver.

    Mental model:
    - 'Holding registers' = knobs you can set (speed/force/position/emcy).
    - 'Input registers'   = sensors you can read (position/motion/error/etc).
    """
